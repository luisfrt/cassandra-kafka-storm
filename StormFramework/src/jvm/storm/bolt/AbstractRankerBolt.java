...
public abstract class AbstractRankerBolt extends BaseBasicBolt {
    ...
    private static final String DEFAULT_BOLT_NAME = "NAMELESS";
    ...
    public AbstractRankerBolt() {
        this(DEFAULT_COUNT, DEFAULT_EMIT_FREQUENCY_IN_SECONDS, DEFAULT_BOLT_NAME);
    }

    public AbstractRankerBolt(int topN, String boltName) {
        this(topN, DEFAULT_EMIT_FREQUENCY_IN_SECONDS, boltName);
    }

    public AbstractRankerBolt(int topN, int emitFrequencyInSeconds, String boltName) {
        if (topN < 1) {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields(CONFIG_FILE.fieldAbstractRankerBoltOutput));
    }
