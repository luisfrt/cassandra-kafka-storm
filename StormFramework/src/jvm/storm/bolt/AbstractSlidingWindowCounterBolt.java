...
public abstract class AbstractSlidingWindowCounterBolt extends BaseRichBolt {
    ...
    public AbstractSlidingWindowCounterBolt() {
        this(DEFAULT_SLIDING_WINDOW_IN_SECONDS, DEFAULT_EMIT_FREQUENCY_IN_SECONDS);
    }
    
    public AbstractSlidingWindowCounterBolt(int windowLengthInSeconds, int emitFrequencyInSeconds) {
    ...
    protected void emit(Map<Object, Long> counts, int actualWindowLengthInSeconds) {
    ...
    protected void countObjAndAck(Tuple tuple) {
        ...
        counter.increaseCount(obj,count);
        collector.ack(tuple);
    }
    
    @Override
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields(CONFIG_FILE.fieldSlidingWindowCounterBoltOutputObject, CONFIG_FILE.fieldSlidingWindowCounterBoltOutputObjectCount, CONFIG_FILE.fieldSlidingWindowCounterBoltSlidingWindowSize));
    }
